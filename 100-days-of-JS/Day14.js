...
// const userId = users.filter(function(val) {
//     if (val.firstName + ' ' + val.lastName === 'Madison Marshall') {
//         return val.id;
//     }
// });
...
const firstArr = users.find(function(val) {
    return (val.id === comments[0].userId);
})
